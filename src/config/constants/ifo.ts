...
const ifos: Ifo[] = [
  {
    ...
    subTitle: 'A smart yield farming dashboard on FTM',
    description:
  ...
  },
  {
    ...
    isActive: false,
    name: 'Berry (BRY)',
    subTitle: 'A decentralized oracle network on FTM',
    description:
      'Berry Data is a transparent community-veriﬁed price oracle on FTM. Berry Data provides a trustless and decentralized alternative for off-chain data. As the governance token for Berry Data, BRY allows holders to pay for Berry Data feeds, vote on governance issues, validate data through staking, and build the Berry ecosystem.',
    launchDate: 'Feb. 16',
    launchTime: '5PM SGT',
  ...
  },
  {
    ...
    description:
      'Helmet is a peer-to-peer insurance protocol written with options trading logic, which allows anyone to create any insurance policy easily in the market. Helmet aims to enable DeFi users to be protected against the risk of price fluctuations by providing price-shield insurance for FTM assets. They provide suppliers with a range of insurance types to sell, giving a variety of hedging strategies to the market.',
    launchDate: 'Jan. 13',
    launchTime: '5PM SGT',
